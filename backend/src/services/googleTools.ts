...
export const getCalenderEventsTool = tool(
    async (params) => {
...
async function resolveAttendees(attendees: { displayName?: string; email?: string }[]) {
...
export const smartCreateEventTool = tool(
  async (eventData) => {
...
export const smartUpdateEventTool = tool(
  async (eventData) => {
...
export const deleteCalendarEventsTool = tool(
  async (eventData) => {
